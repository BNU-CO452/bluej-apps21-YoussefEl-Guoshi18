...
public class StockList {
   ...
   /**
    * This will check to see if the product in the list has the same ID has the new product declared in the param id.
    * If its found then the new product isn't made, but if not then the new product is made.
    */
   ...
   /**
    * This allow the product in low to increase by the amount declared in the param.
    */
